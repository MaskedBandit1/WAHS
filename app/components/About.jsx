    ...
    render: function(){
        return(
            <div>
                ...
                <p className="text-center page-title"><a href="https://github.com/WAHS-News/WAHS">Check out the git repo at https://github.com/WAHS-News/WAHS !</a></p>
                ...
                <ul className="text-center page-title">
                    ...
                    <li className="text-center page-title">
                        ...
                        &nbsp;
                        &nbsp;
                        <a href="https://jquery.com/">jQuery</a> - We used
                    ...
                    <li className="text-center page-title">
                        ...
                        &nbsp;
                        &nbsp;
                        <a href="https://www.heroku.com/">Heroku</a> - We used
                    ...
                    <li className="text-center page-title">
                        ...
                        &nbsp;
                        &nbsp;
                        <a href="https://github.com/MaskedBandit1/WAHS">Github</a> - We used
